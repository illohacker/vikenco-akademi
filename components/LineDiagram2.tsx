...
const zones: ZoneData[] = [
  ...
  {
    id: 'perfeccion', x: 475, y: 101, width: 50, height: 310,
    labelKey: 'perfeccion', color: '#22c55e', lessonId: 'l2-perfeccion',
    people: [{ x: 499, y: 320 }]
  },
  {
    id: 'caja', x: 365, y: 98, width: 110, height: 310,
    labelKey: 'caja', color: '#3b82f6', lessonId: 'l2-caja',
    people: [{ x: 420, y: 310 }, { x: 443, y: 360 }]
  },
  {
    id: 'peso', x: 250, y: 100, width: 110, height: 310,
    labelKey: 'peso', color: '#6366f1', lessonId: 'l2-peso',
    people: [{ x: 304, y: 318 }]
  },
  {
    id: 'noapto', x: 117, y: 98, width: 110, height: 310,
    labelKey: 'noapto', color: '#8b5cf6', lessonId: 'l2-noapto',
    people: [{ x: 196, y: 215 }]
  },
]
...
export default function LineDiagram2({ title, labels }: { title: string; labels: Labels }) {
